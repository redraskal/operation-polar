...
import com.frostedmc.core.cosmetics.handler.FreezeRayHandler;
 ...
 */
public class CosmeticsGadgetsGUI {

    private Player player;
    private JavaPlugin javaPlugin;
    private int page;

    public CosmeticsGadgetsGUI(Player player, JavaPlugin javaPlugin) {
        this.player = player;
    ...
    private void handlePage1() {
        new ChestGUI(player, 45, "Cosmetics | Gadgets » Page 1", false, new GUICallback() {
            @Override
            public void callback(ChestGUI gui, CallbackType callback, ItemStack item) {
                if(callback == CallbackType.INIT) {
                    gui.i.setItem(11, ItemCreator.getInstance().createItem(Material.FIREWORK, 1, 0, "&b&lFirework", Utils.convert(new String[]{
                            "&eIt's pretty simple,",
                    ...
                    gui.i.setItem(12, ItemCreator.getInstance().createItem(Material.INK_SACK, 1, 8, "&7&l???", Utils.convert(new String[]{
                            "&eLore coming soon.",
                            "&b",
                            " &a&lLeft-Click to Equip",
                            "&7&oNot unlocked",
                    ...
                    gui.i.setItem(13, ItemCreator.getInstance().createItem(Material.INK_SACK, 1, 8, "&7&l???", Utils.convert(new String[]{
                            "&eLore coming soon.",
                            "&b",
                            " &a&lLeft-Click to Equip",
                            "&7&oNot unlocked",
                    ...
                    gui.i.setItem(14, ItemCreator.getInstance().createItem(Material.INK_SACK, 1, 8, "&7&l???", Utils.convert(new String[]{
                            "&eLore coming soon.",
                            "&b",
                            " &a&lLeft-Click to Equip",
                            "&7&oNot unlocked",
                    ...
                    gui.i.setItem(15, ItemCreator.getInstance().createItem(Material.INK_SACK, 1, 8, "&7&l???", Utils.convert(new String[]{
                            "&eLore coming soon.",
                            "&b",
                            " &a&lLeft-Click to Equip",
                            "&7&oNot unlocked",
                ...
                if(callback == CallbackType.CLICK) {
                    if(item != null) {
                        ...
                        if(!d.isEmpty()) {
                            ...
                            if(d.equalsIgnoreCase("firework")) {
                                new FreezeRayHandler(player, javaPlugin);
                            }
                        }
                    }
                }
