package com.frostedmc.hub.util;
...
public class NPC implements Listener {
    ...
    public NPC(JavaPlugin javaPlugin, String displayName, String skinTexture, String skinSignature, Location location, NPCInteractEvent npcInteractEvent) {
        javaPlugin.getServer().getPluginManager().registerEvents(this, javaPlugin);
        this.customPlayer = new CustomPlayer(location, displayName, skinTexture, skinSignature, npcInteractEvent);
    ...
    public class CustomPlayer extends EntityPlayer {
        ...
        public CustomPlayer(Location location, String username, String skinTexture, String skinSignature, NPCInteractEvent npcInteractEvent) {
            super(NMS.getServer(), NMS.getHandle(location.getWorld()), makeProfile(username, skinTexture, skinSignature), new PlayerInteractManager(NMS.getHandle(location.getWorld())));
            ...
            this.getDataWatcher().watch(10, b);
        }
    ...
    private static GameProfile makeProfile(String username, String skinTexture, String skinSignature) {
        GameProfile profile = new GameProfile(UUID.randomUUID(), username);

        PropertyMap propertyMap = profile.getProperties();
        propertyMap.put("textures", new Property("textures", skinTexture, skinSignature));
